...
<h3>1. Calculate the selection of ACB, MCCB</h3>
 ...
 <p>Trạm phân phối được thiết kế với 02 Máy biến áp 400kVA, Y/Y, 22/0.4kV kết nối tới 02 thanh cái C1, C2 thông qua máy cắt ACB 01, ACB 02. Một máy cắt liên lạc ACB 03 được sử dụng để nối giữa 2 thanh cái. Khi có sự cố hay cần bảo trì, thay thế Máy biến áp, 1 trong 2 ACB ngắt điện, máy cắt 03 sẽ đóng để cấp nguồn cho nhóm phụ tải còn lại.</p>
 <p align="center">
...
<p>Quản lý dữ liệu về tủ điện, thiết bị và người dùng. Cung cấp các tính năng lọc, tìm kiếm dữ liệu và phân trang.</p>
<p align="center">
